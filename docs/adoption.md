...
use ESLint; keep its plugin and parser configuration. Oxlint supports the
same rule settings and file overrides.
...
as you fix findings. Oxlint supports the same flag.
