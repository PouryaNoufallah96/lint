...
export const RULES = {
  ...
  "shadcn/no-arbitrary-values": ["error", NO_ARBITRARY_VALUES_OPTIONS],
...
export function rulesFor(manifest) {
  ...
  return {
    ...RULES,
    "shadcn/no-restyle": ["error", { ...NO_RESTYLE_OPTIONS, ...options }],
    "shadcn/require-static-classes": ["error", options],
  }
}
