  ...
  test("allow opens, deny subtracts, a contract replaces both", () => {
    tester.run("no-raw-colors", noRawColors as any, {
      valid: [
        ...
        {
          filename: PAGE,
          code: `${button}\nexport const A = () => <Button className="bg-amber-500">Go</Button>`,
          options: [
      ...
      invalid: [
        ...
        {
          filename: PAGE,
          code: `export const A = () => <div className="bg-amber-500" />`,
          options: [{ allow: ["*-amber-*"], deny: ["bg-amber-500"] }],
        ...
        {
          filename: PAGE,
          code: `${button}\nexport const A = () => <Button className="bg-pink-500">Go</Button>`,
          options: [
            {
              contracts: [
                {
        ...
        {
          filename: PAGE,
          code: `export const A = () => <div className="bg-amber-500 bg-pink-500" />`,
  ...
  test("everything minus a deny, and a per-component width", () => {
    tester.run("no-arbitrary-values", noArbitraryValues as any, {
      valid: [
        {
          filename: PAGE,
          code: `export const A = () => <div className="w-[320px] p-[13px]" />`,
      ...
      invalid: [
        {
          filename: PAGE,
          code: `export const A = () => <div className="text-[13px]" />`,
          options: [{ allow: ["*"], deny: ["text-*"] }],
              ...
              suggestions: [
                {
                  ...
                  output: `export const A = () => <div className="w-80" />`,
                },
              ],
            },
          ],
  ...
  test("{{component}} and {{file}} are filled on every finding", () => {
    tester.run("no-arbitrary-values", noArbitraryValues as any, {
      ...
      invalid: [
        {
          filename: PAGE,
          code: `${button}\nexport const A = () => <Button className="p-[13px]">Go</Button>`,
          options: [
            {
              message:
              ...
              suggestions: [
                {
                  ...
                  output: `${button}\nexport const A = () => <Button className="p-3.25">Go</Button>`,
                },
              ],
            },
          ],
        ...
        {
          filename: PAGE,
          code: `export const A = () => <div className="!p-[13px] p-[13px]!" />`,
          errors: [
            {
              messageId: "arbitraryValueWithScale",
              ...
              suggestions: [
                {
                  messageId: "useScale",
                  data: { replacement: "!p-3.25" },
                  output: `export const A = () => <div className="!p-3.25 p-[13px]!" />`,
                },
              ],
            },
            {
              ...
              suggestions: [
                {
                  messageId: "useScale",
                  data: { replacement: "p-3.25!" },
                  output: `export const A = () => <div className="!p-[13px] p-3.25!" />`,
                },
              ],
            },
          ],
  ...
  test("a library's classes on the one component that renders them", () => {
    tester.run("no-unknown-classes", noUnknownClasses as any, {
      valid: [
        {
          filename: PAGE,
          code: `${button}\nexport const A = () => <Button className="prose prose-sm">Go</Button>`,
          options: [
            {
        ...
        {
          filename: PAGE,
          code: `export const A = () => <div className="prose-sm" />`,
      ...
      invalid: [
        {
          filename: PAGE,
          code: `export const A = () => <div className="prose-xl" />`,
          options: [{ allow: ["prose-*"], deny: ["prose-xl"] }],
          errors: [{ messageId: "unknownClass" }],
        },
        {
          filename: PAGE,
          code: `export const A = () => <div className="prose" />`,
...
describe("no-inline-styles", () => {
  test("properties: deny subtracts from a glob, a contract is per component", () => {
    tester.run("no-inline-styles", noInlineStyles as any, {
      valid: [
        {
          code: `export const A = () => <div style={{ borderWidth: 2 }} />`,
          options: [{ allow: ["border-*"], deny: ["borderColor"] }],
        },
        {
          code: `export const A = ({ x }: { x: number }) => <Motion style={{ transform: \`translateX(\${x}px)\` }} />`,
          options: [
      ...
      invalid: [
        {
          code: `export const A = () => <div style={{ borderColor: "red" }} />`,
          options: [{ allow: ["border-*"], deny: ["borderColor"] }],
          errors: [{ messageId: "inlineStyle" }],
        },
        // The contract names Motion; a div is the top-level policy's.
        {
          code: `export const A = () => <div style={{ transform: "none" }} />`,
          options: [
            { contracts: [{ pattern: "^Motion$", allow: ["transform"] }] },
          ],
          errors: [{ messageId: "inlineStyle" }],
        ...
        {
          code: `export const A = () => <Motion style={{ color: "red" }} />`,
          options: [
            {
              contracts: [
                {
        ...
        // deny alone is a denylist.
        {
          code: `export const A = () => <div style={{ color: "red", padding: 4 }} />`,
          options: [{ deny: ["color"] }],
...
describe("policies across rules", () => {
  test("an omitted allow and an empty allow are different policies", () => {
    ...
    expect(
      run({
        "shadcn/no-restyle": ["error", { deny: ["p-*"] }],
        "shadcn/no-arbitrary-values": ["error", { allow: [], deny: ["p-*"] }],
      })
    ).toEqual(["shadcn/no-arbitrary-values"])
    expect(
      run({
        "shadcn/no-arbitrary-values": ["error", { allow: [], deny: ["p-*"] }],
        "shadcn/no-restyle": ["error", { deny: ["p-*"] }],
...
describe("no-inline-styles names", () => {
  test("member tags are components, and custom properties keep their names", () => {
    tester.run("no-inline-styles", noInlineStyles as any, {
      valid: [
        {
          code: `export const A = () => <motion.div style={{ transform: "none" }} />`,
          options: [
            {
              contracts: [{ pattern: "^motion\\.div$", allow: ["transform"] }],
            },
          ],
        },
        {
          code: `export const A = () => <Chart style={{ "--chart-1": "red" }} />`,
          options: [{ allow: ["--chart-1"] }],
        },
        {
          code: `export const A = () => <Chart style={{ "--chart-1": "red", "--chart-2": "blue" }} />`,
          options: [{ allow: ["--chart-*"] }],
        },
      ],
      invalid: [
  ...
  test("allow: [layout] does not exempt an unclassified name", () => {
    tester.run("no-unknown-classes", noUnknownClasses as any, {
      valid: [
        {
          filename: PAGE,
          code: `export const A = () => <div className="mt-4 flex" />`,
